      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="pinCode.php">
            ...
            <span class="menu-title">Add Pincode</span>
          </a>
        </li>
        <li class="nav-item menu-items">
        ...
        <!-- <li class="nav-item menu-items">
          <a class="nav-link" href="comingSoon.php">
            ...
            <span class="menu-title">Add Bussiness</span>
          </a>
        </li> -->
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="comingSoon.php">Add Bussiness </a></li>
              <li class="nav-item"> <a class="nav-link" href="comingSoonList.php"> List Bussiness </a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="media">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="adminMedia.php">Add Media</a></li>
              <li class="nav-item"> <a class="nav-link" href="listMedia.php"> List Media </a></li>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="blog">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="blog_cat.php">Add Category </a></li>
              <li class="nav-item"> <a class="nav-link" href="blog.php"> Add Blog </a></li>
              <li class="nav-item"> <a class="nav-link" href="blog_list.php">Blog List</a></li>
