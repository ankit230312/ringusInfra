...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM features WHERE id = $propertyId";
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($features)) {
        ...
        $updateQuery = "UPDATE features SET property_id='$property_id',features = '$features', updated = CURDATE() WHERE id = $propertyId";
        ...
        if ($updateResult) {
            echo "<script>alert('Feature updated successfully!')</script>";
            echo "<script>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select name="property_id" id="property_id" class="form-control">
                                                            ...
                                                            {
                                                                $selected = ($row['propertyId'] == $row_data['property_id']) ? 'selected' : '';
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">Add Feature</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="feature" value="<?php echo $row_data['features'] ; ?>" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
