...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM pincode WHERE id = $propertyId";
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($propertyPincode)) {
        ...
        $updateQuery = "UPDATE pincode SET pincode = '$propertyPincode', updated = CURDATE() WHERE id = $propertyId";
        ...
        if ($updateResult) {
            ...
            echo "Error updating pincode: " . mysqli_error($conn);
        }
    } else {
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" name="propertyPincode" value="<?php echo $row_data['pincode']  ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
