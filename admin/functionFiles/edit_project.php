...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM upcomingproject WHERE id = $propertyId";
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["projectImage"]["size"] > 0) {
        ...
        $sql = "UPDATE upcomingproject SET projectName='$projectName', projectDescription='$projectDescription', projectUrl='$projectUrl', projectImage='$target_file' WHERE id = $propertyId";
    } else {
        // Update data without changing project image
        $sql = "UPDATE upcomingproject SET projectName='$projectName', projectDescription='$projectDescription', projectUrl='$projectUrl' WHERE id = $propertyId";
    }
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="projectName" value="<?php echo $row_data['projectName'] ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="projectdesc" value="<?php echo $row_data['projectDescription'] ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="projectUrl" value="<?php echo $row_data['projectUrl'] ?> class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
