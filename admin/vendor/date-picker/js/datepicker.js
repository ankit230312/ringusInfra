    ...
    datepicker.Body.prototype = {
        ...
        _getCellContents: function (date, type) {
            ...
            if (opts.onRenderCell) {
                ...
                html = render.php ? render.php : html;
        ...
        _getDayHtml: function (date) {
           var content = this._getCellContents(date, 'day');
            ...
            return '<div class="' + content.classes + '" ' +
                ...
                'data-year="' + date.getFullYear() + '">' + content.php + '</div>';
        },
        ...
        _getMonthHtml: function (date) {
            ...
            return '<div class="' + content.classes + '" data-month="' + date.getMonth() + '">' + content.php + '</div>'
        },
        ...
        _getYearHtml: function (date) {
            ...
            return '<div class="' + content.classes + '" data-year="' + date.getFullYear() + '">' + content.php + '</div>'
        },
...
;(function () {
    ...
    datepicker.Timepicker.prototype = {
        ...
        _updateCurrentTime: function () {
            ...
            this.$hoursText.php(h);
            this.$minutesText.php(m);

            if (this.d.ampm) {
                this.$ampm.php(this.dayPeriod);
            }
        },
