    ...
    <footer class="footer set-bg" data-setbg="img/footer-bg.jpg">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer__contact__option">
                            <div class="option__item"><i class="fa fa-phone"></i> +91 9990905163</div>
                            <div class="option__item email"><i class="fa fa-envelope-o"></i> info@carhai.in</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="footer__about">
                        ...
                        <p>Any questions? Let us know, call us on +91 9990905163</p>
            ...
            <div class="footer__copyright__text">
                <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://carhai.com" target="_blank">Carhai</a></p>
            </div>
